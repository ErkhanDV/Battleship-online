...
const shipsLocationSlice = createSlice({
  ...
  reducers: {
    ...
    addRivalMiss(state, action: PayloadAction<number>) {
      state.rivalMisses.push(action.payload);
    },
    ...
    updateShipsLocationState(state, action: PayloadAction<IShipsLocation>) {
      state.shipsLocation = action.payload.shipsLocation;
      state.rivalShipsLocations = action.payload.rivalShipsLocations;
      state.misses = action.payload.misses;
    },
  },
});
